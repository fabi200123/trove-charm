...
class TroveCharmDeployment(amulet_deployment.OpenStackAmuletDeployment):
    """Amulet tests on a basic trove deployment."""

    def __init__(self, series, openstack=None, source=None, stable=False):
        """Deploy the entire test environment."""
        super().__init__(series, openstack, source, stable)
        self._add_services()
        self._add_relations()
    ...
    def _add_services(self):
        ...
        super()._add_services(this_service, other_services)
    ...
    def _add_relations(self):
        ...
        super()._add_relations(relations)
    ...
    def _configure_services(self):
        ...
        super()._configure_services(configs)
    ...
    def _initialize_tests(self):
        ...
        self.trove_svcs = ['haproxy', 'trove-api', 'trove-conductor',
                           'trove-taskmanager']
